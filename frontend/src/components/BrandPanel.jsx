      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="space-y-4">
          <h1 className="max-w-lg text-5xl font-semibold leading-[1.02] tracking-tight text-white">
            Turn shared lunch orders into a clean operating rhythm.
          </h1>
        ...
        <div className="glass-panel rounded-[28px] p-6">
          <div className="mb-5 flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-3xl font-semibold text-white">98.4%</p>
            </div>
            <div className="rounded-2xl border border-emerald-300/25 bg-emerald-300/12 px-3 py-2 text-sm text-emerald-100">
              On schedule
            </div>
          </div>
          ...
          <div className="grid gap-3 md:grid-cols-3">
            {highlights.map(({ icon: Icon, title, description }) => (
              <div
                className="rounded-3xl border border-white/8 bg-slate-900/50 p-4"
                key={title}
              >
